...
extern const u8 gNameChoice_Samuel[];
extern const u8 gNameChoice_Elvis[];
extern const u8 gNameChoice_Ash[];
extern const u8 gNameChoice_Liam[];
extern const u8 gNameChoice_Nelson[];
...
extern const u8 gNameChoice_Vee[];
