...
const u8 gMoveDescription_Fairy_Wind[] = _("The user stirs up\n a fairy wind \nand strikes the\n target with it.");
...
const u8 gMoveDescription_DrainingKiss[] = _("The user forces a\nkiss on the foe\nwith a fey energy\nthat drains target");
...
const u8 gMoveDescription_BraveBird[] = _("The user tucks its\nwings and attacks\nlow. The user\nalso takes damage.");
const u8 gMoveDescription_CureWounds[] = _("Restores the user's\nHP. The move\nreaches deep into\nthe will power.");
...
const u8 gMoveDescription_DisarmingVoice[] = _("Letting out a cry\nthe user does emotional\ndamage to target\nThis attack never misses.$");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_FAIRY_WIND    - 1] = gMoveDescription_Fairy_Wind,
    ...
    [MOVE_CURE_WOUNDS   - 1] = gMoveDescription_CureWounds,
    ...
    [MOVE_PLAY_ROUGH    - 1] = gMoveDescription_MistBall,
