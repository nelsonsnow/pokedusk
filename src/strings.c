...
const u8 gText_OakForbidsUseOfItemHere[] = _("This isn't the time to use this...{PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("Can't dismount here.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_YourName[] = _("YOUR NAME?");
const u8 gText_BoxName[] = _("BOX NAME?");
>>>>>>> 6a613b67b92da5dbc493d0512f6e274b6899a396
