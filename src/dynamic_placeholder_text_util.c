...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_OFFICERJENNY / 2]            = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE),
    [OBJ_EVENT_GFX_JESSIE / 2]                  = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE),
    [OBJ_EVENT_GFX_JAMES / 2]                   = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE),
};
